...
export const generateBananoReceiveBlock = async (balance: bigint, representative: string, sender: string, recipient: string, previous: string = undefined, previousBalance: bigint = undefined) => {
